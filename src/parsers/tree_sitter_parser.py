...
class TreeSitterJavaParser:
    ...
    def _find_class_node(self, root: Node) -> Optional[Node]:
        """Find the main class, interface, or enum declaration node."""
        # Try class first
    ...
    def _extract_class_info(self, class_node: Node, source: str) -> Dict[str, any]:  # type: ignore
        """Extract class/interface/enum basic information."""
        info: Dict[str, any] = {  # type: ignore
            "modifiers": [],
            "implements": [],
        }
    ...
    def _parse_modifiers(self, modifiers_node: Node, source: str) -> List[str]:
        """Parse Java modifiers (public, private, static, etc.)."""
        modifiers = []
        modifier_types = [
            "public",
            "private",
    ...
    def _categorize_class(
        ...
        """Determine class category based on annotations and naming."""
