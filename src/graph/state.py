...
from src.models.domain_models import DomainKnowledge
...
class ConversionState(TypedDict, total=False):
    ...
    # ============================================================
    # Domain Knowledge (LLM-extracted)
    # ============================================================
    domain_knowledge: Optional[DomainKnowledge]  # Complete domain knowledge model
...
def create_initial_state(
    ...
    return ConversionState(
        ...
        # Domain knowledge (not yet extracted)
